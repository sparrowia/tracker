...
export default function VendorsPage() {
  ...
  function openCreate() {
    ...
    setEditing(false);
    setCreating(true);
    setEditForm({ name: "", slug: "", website: "", notes: "" });
  }
  ...
  async function saveCreate() {
    ...
    if (!error && data) {
      const newVendor: VendorWithCounts = { ...data, actionCount: 0, blockerCount: 0, peopleCount: 0 };
                ...
                <input
                  ...
                  onBlur={() => {
                    if (editForm.name && !editForm.slug) {
                      setEditForm((f) => ({ ...f, slug: generateSlug(f.name) }));
                    }
                  }}
