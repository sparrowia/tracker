  ...
  function DocsEditor({ markdown }, ref) {
    ...
    return (
      <div className="border border-gray-300 rounded-lg overflow-hidden">
        ...
        <div className="p-4">
          <style>{`
            .ProseMirror table { border-collapse: collapse !important; width: 100% !important; margin: 0.75rem 0 !important; }
            .ProseMirror th, .ProseMirror td { border: 1px solid #d1d5db !important; padding: 0.25rem 0.5rem !important; font-size: 0.875rem !important; min-width: 80px !important; }
            .ProseMirror th { background: #f9fafb !important; font-weight: 500 !important; font-size: 0.75rem !important; color: #6b7280 !important; text-align: left !important; }
